...
export function handleTeamPointIncrease(event: TeamPointIncrease): void {
  ...
  if (team === null) {
    log.error(
      "Error in contract, increased point when teamId: {} was not created.",
...
export function handleUserNew(event: UserNew): void {
  ...
  if (team === null) {
    log.error(
      "Error in contract, joined team when teamId: {} was not created.",
      [event.params.teamId.toString()]
    );
  }
...
export function handleUserPause(event: UserPause): void {
  ...
  if (user === null) {
    log.error(
      "Error in contract, paused user when userId: {} was not created.",
  ...
  if (team === null) {
    log.error(
      "Error in contract, paused user when teamId: {} was not created.",
      [event.params.teamId.toString()]
    );
  }
...
export function handleUserReactivate(event: UserReactivate): void {
  ...
  if (user === null) {
    log.error(
      "Error in contract, resumed user when userId: {} was not created.",
      [event.params.userAddress.toHex()]
    );
  }
  user.isActive = true;
  ...
  if (team === null) {
    log.error(
      "Error in contract, resumed user when teamId: {} was not created.",
      [event.params.teamId.toString()]
    );
  }
  team.totalUsers = team.totalUsers.plus(ONE_BI);
...
export function handleUserChangeTeam(event: UserChangeTeam): void {
  ...
  if (oldTeam === null) {
    log.error(
      "Error in contract, changed team when (old) teamId: {} was not created.",
  ...
  if (newTeam === null) {
    log.error(
      "Error in contract, changed team when (new) teamId: {} was not created.",
  ...
  if (user === null) {
    log.error(
      "Error in contract, changed team when userId: {} was not created.",
      [event.params.userAddress.toHex()]
    );
  }
...
export function handleUserPointIncrease(event: UserPointIncrease): void {
  ...
  if (user === null) {
    log.error(
      "Error in contract, increased point when userId: {} was not created.",
      [event.params.userAddress.toHex()]
    );
  }
...
export function handleUserPointIncreaseMultiple(
