...
import { ChampagneFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = ChampagneFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new ChampagneFactory(FACTORY_ADDRESS);
