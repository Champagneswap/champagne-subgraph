...
export class ChampagneFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save ChampagneFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save ChampagneFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("ChampagneFactory", id.toString(), this);
  }

  static load(id: string): ChampagneFactory | null {
    return store.get("ChampagneFactory", id) as ChampagneFactory | null;
  }
...
export class ChampagneDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save ChampagneDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save ChampagneDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("ChampagneDayData", id.toString(), this);
  }

  static load(id: string): ChampagneDayData | null {
    return store.get("ChampagneDayData", id) as ChampagneDayData | null;
  }
