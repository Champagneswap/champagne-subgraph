...
export class Lottery__viewLotteryResultValue0Struct extends ethereum.Tuple {
  ...
  get chamPerBracket(): Array<BigInt> {
  ...
  get amountCollectedInCham(): BigInt {
...
export class Lottery extends ethereum.SmartContract {
  ...
  maxPriceTicketInCham(): BigInt {
    let result = super.call(
      "maxPriceTicketInCham",
      "maxPriceTicketInCham():(uint256)",
      []
    );
  ...
  try_maxPriceTicketInCham(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxPriceTicketInCham",
      "maxPriceTicketInCham():(uint256)",
      []
  ...
  minPriceTicketInCham(): BigInt {
    let result = super.call(
      "minPriceTicketInCham",
      "minPriceTicketInCham():(uint256)",
      []
    );
  ...
  try_minPriceTicketInCham(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "minPriceTicketInCham",
      "minPriceTicketInCham():(uint256)",
      []
...
export class SetMinAndMaxTicketPriceInChamCall extends ethereum.Call {
  get inputs(): SetMinAndMaxTicketPriceInChamCall__Inputs {
    return new SetMinAndMaxTicketPriceInChamCall__Inputs(this);
  }

  get outputs(): SetMinAndMaxTicketPriceInChamCall__Outputs {
    return new SetMinAndMaxTicketPriceInChamCall__Outputs(this);
  }
}

export class SetMinAndMaxTicketPriceInChamCall__Inputs {
  _call: SetMinAndMaxTicketPriceInChamCall;

  constructor(call: SetMinAndMaxTicketPriceInChamCall) {
    this._call = call;
  }

  get _minPriceTicketInCham(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _maxPriceTicketInCham(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}

export class SetMinAndMaxTicketPriceInChamCall__Outputs {
  _call: SetMinAndMaxTicketPriceInChamCall;
